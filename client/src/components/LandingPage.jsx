            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Review marketing content for compliance in <span className='line-through'>50 minutes</span> <span className='text-teal-700'>4 seconds</span>.
                </h1>
        ...
        <div className="py-24 sm:pt-48">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-center text-xl leading-8 text-gray-600">
              The average compliance professional costs ~<strong>$65 an hour.</strong><br />That time should be spent on high-impact work.
            </p>
                ...
                >
                  ...
                  <a
                    ...
                    className={classNames(
                      ...
                      'mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600'
                    )}
                  >
                    Buy plan
                  </a>
